        ...
        youtubeVideoGallery:function(options) {
            var version = '1.3.1',
                ...
                defaults = {
                    ...
                    iframeTemplate:'<div id="youtube-videogallery-iframe" style="height:{options.innerHeight}px;width:{options.innerWidth}px;"></div>',
                    innerHeight:480,
                    innerWidth:854,
            ...
            function open(e){
                ...
                const tube_id = $(el).attr('data-youtube-id');
                options.videoInitializer = options.videoInitializer || function(){};
                options.videoInitializer('youtube-videogallery-iframe', tube_id);
            ...
            function close(e){
                ...
                $('#youtube-videogallery-iframe').replaceWith(getIframeTemplate(options.innerWidth, options.innerHeight));
            }
